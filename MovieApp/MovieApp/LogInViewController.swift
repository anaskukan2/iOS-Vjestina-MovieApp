...
class LogInViewController: UIViewController {
    ...
    private func styleViews(){
        ...
        textFieldStyle(placeholder: "ex. Matt@iosCourse.com", textField: emailTextField)
        textFieldStyle(placeholder: "Enter your password", textField: passwordTextField)
    ...
    private func textFieldStyle(placeholder: String, textField: UITextField) {
        textField.backgroundColor = UIColor(red: 0.073, green: 0.23, blue: 0.387, alpha: 1)
        textField.layer.cornerRadius = 10
        textField.attributedPlaceholder = NSAttributedString(
            string: placeholder,
            attributes: [NSAttributedString.Key.foregroundColor: UIColor(red: 0.298, green: 0.698, blue: 0.87, alpha: 1.0)]
            )
